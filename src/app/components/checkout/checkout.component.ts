...
import { ParseFromUrlFunction } from '@okta/okta-auth-js';
...
export class CheckoutComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.luv2ShopFormService.getCreditCardMonths(startMonth).subscribe(
      data => {
        ...
        console.log(`The month array ${JSON.stringify(data)}`);
  ...
  handleMonthsAndYears(){
    ...
    this.luv2ShopFormService.getCreditCardMonths(startMonth).subscribe(
      data => {
        console.log(`The credit card months: ${JSON.stringify(data)}`);
        this.creditCardMonths = data;
    });
  }
